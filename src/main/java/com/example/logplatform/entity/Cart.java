...
public class Cart extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (getRent() != null ? !getRent().equals(cart.getRent()) : cart.getRent() != null) return false;
        return getRentTime() != null ? getRentTime().equals(cart.getRentTime()) : cart.getRentTime() == null;
    }
