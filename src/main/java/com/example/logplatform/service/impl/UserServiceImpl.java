...
import com.example.logplatform.mapper.UserMapper;
import com.example.logplatform.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public void register(User user) {
        ...
        if (username == "") {
            throw new UsernameDuplicateException("未输入用户名");
        }
        ...
        if (rows != 1) {
            ...
            throw new InsertException("添加用户数据出现未知错误，请联系客服");
        }
    }
    ...
    public User login(String username, String password) {
        ...
        // 判断查询结果中的isDelete是否为1，判断用户是否被注销
    ...
    public void changeInfo(Integer uid, String username, User user) {
        ...
        if (rows != 1) {
            ...
            throw new UpdateException("更新用户数据时出现未知错误，请联系客服");
        }
    }
